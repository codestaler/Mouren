...
class ChatMascotaController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $systemPrompt = "Eres Mouri, el cuervo mascota y guardián místico de 'Mouren Funeraria'. "
            ...
            . "  4. 'Tus datos': Información del perfil aqui tambien puedes descarcar tu certificado de afiliacion a la funeraria.\n"
            . "  Si tiene una duda muy puntual, o algun error tecnico con la pagina dale el numero de soporte y servicio al cliente 3247697845\n"
            . "  3. 'eb detalles plan puedes personalizar detalles de \n"
