...
// 🆕 Modal de doble autorización para eliminar un afiliado:
// Paso 1: advierte claramente que dejará de contar en el costo del plan.
// Paso 2: pide escribir el nombre exacto del afiliado para confirmar.
// Es un componente NUEVO y separado — no toca ModalConfirmarEliminar.jsx,
// que puede seguir usándose tal cual en cualquier otro lugar que ya lo use.
// Mismo patrón que ya usamos en ModalConfirmarEliminarMascota.jsx.
export default function ModalConfirmarEliminarAfiliado({ visible, afiliado, ejecutarEliminacion, cerrarModal }) {
